let
	...
	src = rec {
		...
		pyLibs = {
			...
			genlayer-std = {
				hash = "sha256-3p1i1zX6i56StXm+IHAZEGzvrHbYDaqQqTx8eeR3xKQ=";
			};
		...
		wrappers = {
			__prefix = "";
			py-genlayer = {
				hash = "sha256-gq4a1fdSAXBwkDqw3YSkKzYLNDLEmsDMRBYlUdidHA8=";
				depends = [
					cpython
					pyLibs.cloudpickle
					pyLibs.genlayer-std
			...
			py-genlayer-multi = {
				hash = "sha256-qvwl0Pz1jHjqc3ir9K4BJ4rbB47c+DdwttLeCEsMXtI=";
				depends = [
					cpython
					pyLibs.cloudpickle
					pyLibs.genlayer-std
