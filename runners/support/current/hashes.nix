let
	...
	src = rec {
		...
		pyLibs = {
			...
			genlayer-std = {
				hash = "sha256-wPpbXwXQFgjkrnJEmhITvP4vwmZMBzJcuG7MEvF8wxw=";
			};
		...
		wrappers = {
			__prefix = "";
			py-genlayer = {
				hash = "sha256-d8uveEtyS6FlswK4ox6SWfARV/cqIMy/jkZk1OOSXYY=";
				depends = [
					cpython
					pyLibs.cloudpickle
					pyLibs.genlayer-std
			...
			py-genlayer-multi = {
				hash = "sha256-RTowArys++dqFszu9KwkktSV40wm2W6dtTj5JqWjhxI=";
				depends = [
					cpython
					pyLibs.cloudpickle
					pyLibs.genlayer-std
