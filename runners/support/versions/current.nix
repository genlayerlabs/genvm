let
	...
	src = rec {
		...
		pyLibs = {
			...
			genlayer-std = {
				hash = "sha256-YSkNZ3Q4V5YKvIahsccz/vrmMKzGHCudWmVqZKZsHMk=";
			};
		...
		wrappers = {
			__prefix = "";
			py-genlayer = {
				hash = "sha256-iUpzX4Xn1v4Ae+PDifOPNX1H2PFdMWBJCwffCclHgsk=";
				depends = [
					cpython
					pyLibs.cloudpickle
					pyLibs.genlayer-std
			...
			py-genlayer-multi = {
				hash = "sha256-UeVY7iVg4XkC8bEsxYXJEPj/fo8Med66a+kK63uIhEM=";
				depends = [
					cpython
					pyLibs.cloudpickle
					pyLibs.genlayer-std
