let
	...
	src = rec {
		...
		pyLibs = {
			...
			genlayer-std = {
				hash = "sha256-i6Zk+ixnU2uvscMHNAAe+DWUOZAKzlUH+FLg01fAqFw=";
			};
		...
		wrappers = {
			__prefix = "";
			py-genlayer = {
				hash = "sha256-cnC9/kUuow48CWhvcHatsqtPJg2qY0ccDiJufKdWYFk=";
				depends = [
					cpython
					pyLibs.cloudpickle
					pyLibs.genlayer-std
			...
			py-genlayer-multi = {
				hash = "sha256-63z7bBi0+QRAxoc45ntL/ZsX6qrdPSBQOZvI7jPxpu4=";
				depends = [
					cpython
					pyLibs.cloudpickle
					pyLibs.genlayer-std
