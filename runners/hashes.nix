let
	src = rec {
		...
		pyLibs = {
			...
			genlayer-std = {
				hash = "sha256-BM/NOm8N7+AVHykdzMSRHmubdSi79Mz645/+im4ZWCs=";
			};
		...
		wrappers = {
			__prefix = "";
			py-genlayer = {
				hash = "sha256-AKdIMnsPWVDQh/hjgXlQG1XRamcXpQQzAAggv+WODpc=";
				depends = [
					cpython
					pyLibs.cloudpickle
					pyLibs.genlayer-std
			...
			py-genlayer-multi = {
				hash = "sha256-BUP+IyMvN7W+EUa6rikV+ysYx5wF39Z9cqakEb93kTM=";
				depends = [
					cpython
					pyLibs.cloudpickle
					pyLibs.genlayer-std
