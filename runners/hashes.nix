let
	src = rec {
		...
		pyLibs = {
			...
			genlayer-std = {
				hash = "sha256-x5GYdhcAxDDDYcjXCtAq9oBlF/ZBUqs6WnM/q7EwIKI=";
			};
		...
		wrappers = {
			__prefix = "";
			py-genlayer = {
				hash = "sha256-OBEmBF39gW2vKSb4ff7yXs/HSzCvdVxPkaNffdQsqx4=";
				depends = [
					cpython
					pyLibs.cloudpickle
					pyLibs.genlayer-std
			...
			py-genlayer-multi = {
				hash = "sha256-lQNf/A3ItCJVJ8TuWz2u1yxOZX6YSvI0Onp3f6YlWmU=";
				depends = [
					cpython
					pyLibs.cloudpickle
					pyLibs.genlayer-std
