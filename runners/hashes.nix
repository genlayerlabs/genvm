let
	src = rec {
		...
		pyLibs = {
			...
			genlayer-std = {
				hash = "sha256-0gwyxZ/MhQv5NFtFBkrqyGXMFzgI0ecIehOUmrkX34I=";
			};
		...
		wrappers = {
			__prefix = "";
			py-genlayer = {
				hash = "sha256-P7hqlu0EfyOxkX8XekTdL3jzFiw8OqpoSkBNqVrTtQo=";
				depends = [
					cpython
					pyLibs.cloudpickle
					pyLibs.genlayer-std
			...
			py-genlayer-multi = {
				hash = "sha256-w4ZNnnovh6Z5Wya/n0wLI8pybnli+yR0yepwObSzyAQ=";
				depends = [
					cpython
					pyLibs.cloudpickle
					pyLibs.genlayer-std
