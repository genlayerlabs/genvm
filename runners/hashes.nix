let
	src = rec {
		...
		pyLibs = {
			...
			genlayer-std = {
				hash = "sha256-ZoUWyUhBi7MAUKY1WBYL0XqmAf+ea0jOfkMhsTeIW7I=";
			};
		...
		wrappers = {
			__prefix = "";
			py-genlayer = {
				hash = "sha256-+uxS+enLWEzy6b/qizAXdsuSVDPq/FRmPeRHnBzIbt4=";
				depends = [
					cpython
					pyLibs.cloudpickle
					pyLibs.genlayer-std
			...
			py-genlayer-multi = {
				hash = "sha256-/ionDS8CVcD6CeJYz1zqNpRmTCf2AhoYDffNrYkMm6Y=";
				depends = [
					cpython
					pyLibs.cloudpickle
					pyLibs.genlayer-std
