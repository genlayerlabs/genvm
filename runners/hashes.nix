let
	src = rec {
		...
		pyLibs = {
			...
			genlayer-std = {
				hash = "sha256-a7iFBzj0/nHnZbkLR2g0jo6FGQDpy0AHRKZvepQKfV4=";
			};
		...
		wrappers = {
			__prefix = "";
			py-genlayer = {
				hash = "sha256-wMG8+wcSnLe+ca4QovkoV3yJtTuWT6ed1FbaChTW6JE=";
				depends = [
					cpython
					pyLibs.cloudpickle
					pyLibs.genlayer-std
			...
			py-genlayer-multi = {
				hash = "sha256-M2rLw+swfwpgfBqEoqUIjGxVIT9VW/0CrTIrPEfFHAU=";
				depends = [
					cpython
					pyLibs.cloudpickle
					pyLibs.genlayer-std
